...
export class BookService {
  ...
  getaddress(reqData: any) {
    ...
    return this.httpService.getService(`https://localhost:7145/api/Address/GetUserAddresses?userid=${userid}`, true, header);
  }
  getBooks(): Observable<any> {
    ...
    return this.httpService.getService('https://localhost:7145/api/Book/GetAllBooks', true,header,);
  }
